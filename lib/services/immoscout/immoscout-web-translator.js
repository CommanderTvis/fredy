...
const WEB_PATH_TO_APARTMENT_EQUIPMENT_MAP = {
  ...
  // Category "Zimmeranzahl" (Number of rooms)
  '1-zimmer-wohnung-mieten': { numberofrooms: '1.0-1.0' },
  '2-zimmer-wohnung-mieten': { numberofrooms: '2.0-2.0' },
  '3-zimmer-wohnung-mieten': { numberofrooms: '3.0-3.0' },
  '4-zimmer-wohnung-mieten': { numberofrooms: '4.0-4.0' },
  '5-zimmer-wohnung-mieten': { numberofrooms: '5.0-5.0' },
};
